...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stave = __webpack_require__(40);
	
	var _stavenote = __webpack_require__(18);
	
	var _stavemodifier = __webpack_require__(42);
	...
	var _tabstave = __webpack_require__(52);
	
	var _tabnote = __webpack_require__(53);
	
	var _bend = __webpack_require__(38);
	
	var _vibrato = __webpack_require__(39);
	
	var _note = __webpack_require__(20);
	
	var _modifiercontext = __webpack_require__(25);
	
	var _tickcontext = __webpack_require__(36);
	
	var _articulation = __webpack_require__(34);
	
	var _annotation = __webpack_require__(37);
	
	var _stavebarline = __webpack_require__(41);
	
	var _notehead = __webpack_require__(19);
	
	var _staveconnector = __webpack_require__(17);
	
	var _clefnote = __webpack_require__(54);
	
	var _keysignature = __webpack_require__(49);
	
	var _timesignature = __webpack_require__(50);
	
	var _timesignote = __webpack_require__(55);
	
	var _stem = __webpack_require__(16);
	
	var _tabtie = __webpack_require__(56);
	
	var _clef = __webpack_require__(48);
	...
	var _tuning = __webpack_require__(59);
	
	var _keymanager = __webpack_require__(60);
	
	var _stavehairpin = __webpack_require__(61);
	
	var _boundingbox = __webpack_require__(6);
	
	var _strokes = __webpack_require__(32);
	
	var _textnote = __webpack_require__(47);
	
	var _curve = __webpack_require__(62);
	
	var _textdynamics = __webpack_require__(63);
	
	var _staveline = __webpack_require__(64);
	
	var _ornament = __webpack_require__(35);
	
	var _pedalmarking = __webpack_require__(65);
	
	var _textbracket = __webpack_require__(66);
	
	var _frethandfinger = __webpack_require__(26);
	
	var _staverepetition = __webpack_require__(43);
	
	var _barnote = __webpack_require__(67);
	
	var _ghostnote = __webpack_require__(68);
	
	var _notesubgroup = __webpack_require__(29);
	
	var _gracenotegroup = __webpack_require__(30);
	
	var _tremolo = __webpack_require__(69);
	
	var _stringnumber = __webpack_require__(33);
	
	var _crescendo = __webpack_require__(70);
	
	var _stavevolta = __webpack_require__(51);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _boundingboxcomputation = __webpack_require__(5);
	...
	var Glyph = exports.Glyph = function () {
	  ...
	  Glyph.prototype.setContext = function setContext(context) {
	    this.context = context;return this;
	  };
	
	  Glyph.prototype.getContext = function getContext() {
	    return this.context;
	  };
	  ...
	  Glyph.prototype.renderToStave = function renderToStave(x) {
	    ...
	    if (!this.context) {
	      throw new _vex.Vex.RERR('GlyphError', 'No valid context');
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Formatter = exports.Formatter = function () {
	  ...
	  Formatter.prototype.preFormat = function preFormat(justifyWidth, renderingContext, voices, stave) {
	    var _this = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Voice = exports.Voice = function () {
	  ...
	  Voice.prototype.draw = function draw(context, stave) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Beam = exports.Beam = function () {
	  ...
	  Beam.prototype.setContext = function setContext(context) {
	    this.context = context;return this;
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tuplet = exports.Tuplet = function () {
	  ...
	  Tuplet.prototype.setContext = function setContext(context) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Stem = exports.Stem = function () {
	  ...
	  Stem.prototype.setContext = function setContext(context) {
	    this.context = context;return this;
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StaveConnector = exports.StaveConnector = function () {
	  ...
	  StaveConnector.prototype.setContext = function setContext(ctx) {
	    this.ctx = ctx;
	    return this;
	  };
	  ...
	  StaveConnector.prototype.draw = function draw() {
	    if (!this.ctx) {
	      throw new _vex.Vex.RERR('NoContext', "Can't draw without a context.");
	    }
	    ...
	    switch (this.type) {
	      ...
	      case StaveConnector.type.BRACE:
	        ...
	        _glyph.Glyph.renderGlyph(this.ctx, topX - 5, topY - 3, 40, 'v1b', true);
	        _glyph.Glyph.renderGlyph(this.ctx, topX - 5, botY + 3, 40, 'v10', true);
	        topX -= this.width + 2;
	        break;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NoteHead = exports.NoteHead = function (_Note) {
	  ...
	  NoteHead.prototype.setContext = function setContext(context) {
	    this.context = context;return this;
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tickable = exports.Tickable = function () {
	  function Tickable() {
	    ...
	    this.tickMultiplier = new _fraction.Fraction(1, 1);
	    this.ticks = new _fraction.Fraction(0, 1);
	    this.width = 0;
	  ...
	  Tickable.prototype.setContext = function setContext(context) {
	    this.context = context;
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	function L() {
	  ...
	  if (Modifier.DEBUG) _vex.Vex.L('Vex.Flow.Modifier', args);
	}
	...
	var Modifier = exports.Modifier = function () {
	  ...
	  Modifier.prototype.getContext = function getContext() {
	    return this.context;
	  };
	
	  Modifier.prototype.setContext = function setContext(context) {
	    this.context = context;return this;
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dot = exports.Dot = function (_Modifier) {
	  ...
	  Dot.prototype.draw = function draw() {
	    if (!this.context) {
	      throw new _vex.Vex.RERR('NoContext', "Can't draw dot without a context.");
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FretHandFinger = exports.FretHandFinger = function (_Modifier) {
	  ...
	  FretHandFinger.prototype.getNote = function getNote() {
	    return this.note;
	  };
	
	  FretHandFinger.prototype.setNote = function setNote(note) {
	    this.note = note;return this;
	  };
	
	  FretHandFinger.prototype.getIndex = function getIndex() {
	    return this.index;
	  };
	
	  FretHandFinger.prototype.setIndex = function setIndex(index) {
	    this.index = index;return this;
	  };
	
	  FretHandFinger.prototype.getPosition = function getPosition() {
	    return this.position;
	  };
	
	  FretHandFinger.prototype.setPosition = function setPosition(position) {
	  ...
	  FretHandFinger.prototype.draw = function draw() {
	    if (!this.context) {
	      throw new _vex.Vex.RERR('NoContext', "Can't draw string number without a context.");
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Accidental = exports.Accidental = function (_Modifier) {
	  ...
	  Accidental.prototype.draw = function draw() {
	    ...
	    if (!context) {
	      throw new _vex.Vex.RERR('NoContext', "Can't draw accidental without a context.");
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NoteSubGroup = exports.NoteSubGroup = function (_Modifier) {
	  ...
	  NoteSubGroup.prototype.draw = function draw() {
	    ...
	    if (!this.context) {
	      throw new _vex.Vex.RuntimeError('NoContext', "Can't draw notes without a context.");
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GraceNoteGroup = exports.GraceNoteGroup = function (_Modifier) {
	  ...
	  GraceNoteGroup.prototype.draw = function draw() {
	    ...
	    if (!this.context) {
	      throw new _vex.Vex.RuntimeError('NoContext', "Can't draw Grace note without a context.");
	    }
	    ...
	    if (this.show_slur) {
	      ...
	      this.slur = new _stavetie.StaveTie({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StaveTie = exports.StaveTie = function () {
	  ...
	  StaveTie.prototype.setContext = function setContext(context) {
	    this.context = context;return this;
	  };
	  ...
	  StaveTie.prototype.draw = function draw() {
	    if (!this.context) {
	      throw new _vex.Vex.RERR('NoContext', 'No context to render tie.');
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Stroke = exports.Stroke = function (_Modifier) {
	  ...
	  Stroke.prototype.draw = function draw() {
	    if (!this.context) {
	      throw new _vex.Vex.RERR('NoContext', "Can't draw stroke without a context.");
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Articulation = exports.Articulation = function (_Modifier) {
	  ...
	  Articulation.prototype.draw = function draw() {
	    ...
	    if (!ctx) {
	      throw new _vex.Vex.RERR('NoContext', "Can't draw Articulation without a context.");
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Ornament = exports.Ornament = function (_Modifier) {
	  ...
	  Ornament.prototype.setUpperAccidental = function setUpperAccidental(acc) {
	  ...
	  Ornament.prototype.setLowerAccidental = function setLowerAccidental(acc) {
	  ...
	  Ornament.prototype.draw = function draw() {
	    if (!this.context) {
	      throw new _vex.Vex.RERR('NoContext', "Can't draw Ornament without a context.");
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TickContext = exports.TickContext = function () {
	  ...
	  TickContext.prototype.setContext = function setContext(context) {
	    this.context = context;return this;
	  };
	
	  TickContext.prototype.getContext = function getContext() {
	    return this.context;
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Annotation = exports.Annotation = function (_Modifier) {
	  ...
	  Annotation.prototype.setJustification = function setJustification(justification) {
	  ...
	  Annotation.prototype.draw = function draw() {
	    if (!this.context) {
	      throw new _vex.Vex.RERR('NoContext', "Can't draw text annotation without a context.");
	    }
	    if (!this.note) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Bend = exports.Bend = function (_Modifier) {
	  ...
	  Bend.prototype.draw = function draw() {
	    if (!this.context) {
	      throw new _vex.Vex.RERR('NoContext', "Can't draw bend without a context.");
	    }
	    if (!(this.note && this.index != null)) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Vibrato = exports.Vibrato = function (_Modifier) {
	  ...
	  Vibrato.prototype.draw = function draw() {
	    ...
	    if (!this.context) {
	      throw new _vex.Vex.RERR('NoContext', "Can't draw vibrato without a context.");
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stavesection = __webpack_require__(44);
	
	var _stavetempo = __webpack_require__(45);
	
	var _stavetext = __webpack_require__(46);
...
/***/ function(module, exports) {
	...
	var StaveModifier = exports.StaveModifier = function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StaveSection = exports.StaveSection = function (_StaveModifier) {
	  ...
	  StaveSection.prototype.draw = function draw(stave, shift_x) {
	    if (!stave.context) {
	      throw new _vex.Vex.RERR('NoContext', "Can't draw stave section without a context.");
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StaveTempo = exports.StaveTempo = function (_StaveModifier) {
	  ...
	  StaveTempo.prototype.draw = function draw(stave, shift_x) {
	    if (!stave.context) {
	      throw new _vex.Vex.RERR('NoContext', "Can't draw stave tempo without a context.");
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StaveText = exports.StaveText = function (_StaveModifier) {
	  ...
	  StaveText.prototype.draw = function draw(stave) {
	    if (!stave.context) {
	      throw new _vex.Vex.RERR('NoContext', "Can't draw stave text without a context.");
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TextNote = exports.TextNote = function (_Note) {
	  ...
	  TextNote.prototype.preFormat = function preFormat() {
	    if (!this.context) {
	      throw new _vex.Vex.RERR('NoRenderContext', "Can't measure text without rendering context.");
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TabStave = exports.TabStave = function (_Stave) {
	  ...
	  function TabStave(x, y, width, options) {
	    ...
	    return _possibleConstructorReturn(this, _Stave.call(this, x, y, width, tab_options));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GraceNote = exports.GraceNote = function (_StaveNote) {
	  ...
	  function GraceNote(note_struct) {
	    ...
	    var _this = _possibleConstructorReturn(this, _StaveNote.call(this, note_struct));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StaveHairpin = exports.StaveHairpin = function () {
	  ...
	  StaveHairpin.prototype.setContext = function setContext(context) {
	    this.context = context;return this;
	  };
	  ...
	  StaveHairpin.prototype.draw = function draw() {
	    if (!this.context) {
	      throw new _vex.Vex.RERR('NoContext', "Can't draw Hairpin without a context.");
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); // VexFlow - Music Engraving for HTML5
	// Copyright Mohit Muthanna 2010
	//
	...
	var Curve = exports.Curve = function () {
	  ...
	  Curve.prototype.setContext = function setContext(context) {
	    this.context = context;return this;
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StaveLine = exports.StaveLine = function () {
	  ...
	  StaveLine.prototype.setContext = function setContext(context) {
	    this.context = context;return this;
	  };
	  ...
	  StaveLine.prototype.applyLineStyle = function applyLineStyle() {
	    if (!this.context) {
	      throw new _vex.Vex.RERR('NoContext', 'No context to apply the styling to');
	    }
	  ...
	  StaveLine.prototype.draw = function draw() {
	    ...
	    if (!this.context) {
	      throw new _vex.Vex.RERR('NoContext', 'No context to render StaveLine.');
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PedalMarking = exports.PedalMarking = function () {
	  ...
	  PedalMarking.prototype.setContext = function setContext(context) {
	    this.context = context;return this;
	  };
	  ...
	  PedalMarking.prototype.draw = function draw() {
	    if (!this.context) {
	      throw new _vex.Vex.RERR('NoContext', "Can't draw PedalMarking without a context.");
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TextBracket = exports.TextBracket = function () {
	  ...
	  TextBracket.prototype.setContext = function setContext(context) {
	    this.context = context;return this;
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tremolo = exports.Tremolo = function (_Modifier) {
	  ...
	  Tremolo.prototype.draw = function draw() {
	    if (!this.context) {
	      throw new _vex.Vex.RERR('NoContext', "Can't draw Tremolo without a context.");
	    }
