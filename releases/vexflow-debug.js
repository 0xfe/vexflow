...
(function (global, factory) {
  ...
  */
    ...
    createClass(Beam, [{
      ...
      value: function calculateSlope() {
        ...
        for (var slope = min_slope; slope <= max_slope; slope += increment) {
          ...
          for (var _i3 = 1; _i3 < notes.length; ++_i3) {
            var _note3 = notes[_i3];
            var adjustedStemTipY = this.getSlopeY(_note3.getStemX(), firstNote.getStemX(), firstNote.getStemExtents().topY, slope) + yShiftTemp;

            var stemTipY = _note3.getStemExtents().topY;
      ...
      value: function calculateFlatSlope() {
        ...
        for (var _i4 = 0; _i4 < notes.length; _i4++) {
          ...
          if (stem_direction === Stem.DOWN && currentExtreme < stemTipY) {
            ...
            extremeY = Math.max.apply(Math, toConsumableArray(_note4.getYs()));
            extremeBeamCount = _note4.getBeamCount();
          } else if (stem_direction === Stem.UP && (currentExtreme === 0 || currentExtreme > stemTipY)) {
            currentExtreme = stemTipY;
            extremeY = Math.min.apply(Math, toConsumableArray(_note4.getYs()));
            extremeBeamCount = _note4.getBeamCount();
          }
        }
      ...
      value: function applyStemExtensions() {
        ...
        for (var _i5 = 0; _i5 < notes.length; ++_i5) {
          var _note5 = notes[_i5];
          var stemX = _note5.getStemX();

          var _note5$getStemExtents = _note5.getStemExtents();

          var stemTipY = _note5$getStemExtents.topY;

          var beamedStemTipY = this.getSlopeY(stemX, firstStemX, firstStemTipY, slope) + y_shift;
          var preBeamExtension = _note5.getStem().getExtension();
          var beamExtension = stem_direction === Stem.UP ? stemTipY - beamedStemTipY : beamedStemTipY - stemTipY;

          _note5.stem.setExtension(preBeamExtension + beamExtension);
          _note5.stem.renderHeightAdjustment = -Stem.WIDTH / 2;

          if (_note5.isRest() && show_stemlets) {
            var beamWidth = beam_width;
            var totalBeamWidth = (beam_count - 1) * beamWidth * 1.5 + beamWidth;
            _note5.stem.setVisibility(true).setStemlet(true, totalBeamWidth + stemlet_extension);
          }
        }
      }
      ...
      value: function getBeamLines(duration) {
        ...
        for (var _i6 = 0; _i6 < this.notes.length; ++_i6) {
          ...
          var stem_x = _note6.getStemX() - Stem.WIDTH / 2;
  ...
  var NoteHead = function (_Note) {
    ...
    createClass(NoteHead, [{
      ...
      value: function getAbsoluteX() {
        ...
        var displacementStemAdjustment = Stem.WIDTH / 2;
  ...
  var getStemAdjustment = function getStemAdjustment(note) {
    return Stem.WIDTH / (2 * -note.getStemDirection());
  };
    ...
    createClass(StaveNote, [{
      ...
      value: function getStemX() {
        if (this.noteType === 'r') {
          ...
          return get(Object.getPrototypeOf(StaveNote.prototype), 'getStemX', this).call(this) + getStemAdjustment(this);
        }
      }
  ...
  var Accidental = function (_Modifier) {
    ...
    createClass(Accidental, null, [{
      ...
      value: function format(accidentals, state) {
        ...
        lineList.forEach(function (line) {
          ...
          for (accCount; accCount < lastAccOnLine; accCount++) {
            ...
            L$6('Line, accCount, shift: ', line.line, accCount, xShift);
          }
        });
      ...
      value: function checkCollision(line1, line2) {
        ...
        L$6('Line_1, Line_2, Collision: ', line1.line, line2.line, collision);
        return collision;
      }
  ...
  var GraceNoteGroup = function (_Modifier) {
    ...
    createClass(GraceNoteGroup, [{
      ...
      value: function draw() {
        ...
        L$7('Drawing grace note group for:', note);
  ...
  var Articulation = function (_Modifier) {
    ...
    createClass(Articulation, [{
      ...
      value: function draw() {
        ...
        L$8('Rendering articulation: ', this.articulation, glyph_x, glyph_y);
  ...
  var Ornament = function (_Modifier) {
    ...
    createClass(Ornament, [{
      ...
      value: function draw() {
        ...
        L$9('Rendering ornament: ', this.ornament, glyph_x, glyph_y);
  ...
  var Annotation = function (_Modifier) {
    ...
    createClass(Annotation, [{
      ...
      value: function draw() {
        ...
        L$10('Rendering annotation: ', this.text, x, y);
    ...
    createClass(ModifierContext, [{
      ...
      value: function preFormat() {
        ...
        this.PREFORMAT.forEach(function (modifier) {
          L$5('Preformatting ModifierContext: ', modifier.CATEGORY);
      ...
      value: function postFormat() {
        ...
        this.POSTFORMAT.forEach(function (modifier) {
          L$5('Postformatting ModifierContext: ', modifier.CATEGORY);
    ...
    createClass(TabNote, [{
      ...
      value: function drawFlag() {
        ...
        if (glyph.flag && shouldDrawFlag) {
          ...
          var flag_code = stem_direction === Stem.DOWN ? glyph.code_flag_downstem // Down stems have flags on the left.
  ...
  var TextDynamics = function (_Note) {
    ...
    function TextDynamics(text_struct) {
      ...
      L$12('New Dynamics Text: ', _this.sequence);
      return _this;
    }
    ...
    createClass(TextDynamics, [{
      ...
      value: function draw() {
        ...
        L$12('Rendering Dynamics: ', this.sequence);
  ...
  var TextBracket = function () {
    ...
    createClass(TextBracket, [{
      ...
      value: function draw() {
        ...
        L$14('Rendering TextBracket: start:', start, 'stop:', stop, 'y:', y);
  ...
  var BarNote = function (_Note) {
    ...
    createClass(BarNote, [{
      ...
      value: function draw() {
        if (!this.stave) throw new Vex.RERR('NoStave', "Can't draw without a stave.");
        L$15('Rendering bar line at: ', this.getAbsoluteX());
  ...
  var Crescendo = function (_Note) {
    ...
    createClass(Crescendo, [{
      ...
      value: function draw() {
        ...
        L$16('Drawing ', this.decrescendo ? 'decrescendo ' : 'crescendo ', this.height, 'x', begin_x - end_x);
