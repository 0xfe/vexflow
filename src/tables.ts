...
export const Tables = {
  ...
  */
  ...
  keyProperties(key: string, clef?: string, params?: any): any {
    ...
    > = {
      C: { index: 0, int_val: 0 },
      'C+': { index: 0, int_val: 0, accidental: '+' },
      'C++': { index: 0, int_val: 0, accidental: '++' },
      'C+-': { index: 0, int_val: 0, accidental: '+-' },
      'C++-': { index: 0, int_val: 0, accidental: '++-' },
      ...
      CD: { index: 0, int_val: 2, accidental: 'd' },
      CDB: { index: 0, int_val: 2, accidental: 'db' },
      CB: { index: 0, int_val: 11, accidental: 'b' },
      CBS: { index: 0, int_val: 11, accidental: 'bs' },
      CBSS: { index: 0, int_val: 11, accidental: 'bss' },
      CBB: { index: 0, int_val: 10, accidental: 'bb' },
      CBBS: { index: 0, int_val: 10, accidental: 'bbs' },
      CK: { index: 0, int_val: 10, accidental: 'k' },
      CO: { index: 0, int_val: 10, accidental: 'o' },
      CAFHF: { index: 0, int_val: 10, accidental: 'afhf' },
      CASHS: { index: 0, int_val: 10, accidental: 'ashs' },
      D: { index: 1, int_val: 2 },
      'D+': { index: 1, int_val: 2, accidental: '+' },
      'D++': { index: 1, int_val: 2, accidental: '++' },
      'D+-': { index: 1, int_val: 2, accidental: '+-' },
      'D++-': { index: 1, int_val: 2, accidental: '++-' },
      ...
      DD: { index: 1, int_val: 4, accidental: 'd' },
      DDB: { index: 1, int_val: 4, accidental: 'db' },
      DB: { index: 1, int_val: 1, accidental: 'b' },
      DBS: { index: 1, int_val: 1, accidental: 'bs' },
      DBSS: { index: 1, int_val: 1, accidental: 'bss' },
      DBB: { index: 1, int_val: 0, accidental: 'bb' },
      DBBS: { index: 1, int_val: 0, accidental: 'bbs' },
      DK: { index: 1, int_val: 0, accidental: 'k' },
      DO: { index: 1, int_val: 0, accidental: 'o' },
      DAFHF: { index: 1, int_val: 0, accidental: 'afhf' },
      DASHS: { index: 1, int_val: 0, accidental: 'ashs' },
      E: { index: 2, int_val: 4 },
      'E+': { index: 2, int_val: 4, accidental: '+' },
      'E++': { index: 2, int_val: 4, accidental: '++' },
      'E+-': { index: 2, int_val: 4, accidental: '+-' },
      'E++-': { index: 2, int_val: 4, accidental: '++-' },
      ...
      ED: { index: 2, int_val: 6, accidental: 'd' },
      EDB: { index: 2, int_val: 6, accidental: 'db' },
      EB: { index: 2, int_val: 3, accidental: 'b' },
      EBS: { index: 2, int_val: 3, accidental: 'bs' },
      EBSS: { index: 2, int_val: 3, accidental: 'bss' },
      EBB: { index: 2, int_val: 2, accidental: 'bb' },
      EBBS: { index: 2, int_val: 2, accidental: 'bbs' },
      EK: { index: 2, int_val: 2, accidental: 'k' },
      EO: { index: 2, int_val: 2, accidental: 'o' },
      EAFHF: { index: 2, int_val: 2, accidental: 'afhf' },
      EASHS: { index: 2, int_val: 2, accidental: 'ashs' },
      F: { index: 3, int_val: 5 },
      'F+': { index: 3, int_val: 5, accidental: '+' },
      'F++': { index: 3, int_val: 5, accidental: '++' },
      'F+-': { index: 3, int_val: 5, accidental: '+-' },
      'F++-': { index: 3, int_val: 5, accidental: '++-' },
      ...
      FD: { index: 3, int_val: 7, accidental: 'd' },
      FDB: { index: 3, int_val: 7, accidental: 'db' },
      FB: { index: 3, int_val: 4, accidental: 'b' },
      FBS: { index: 3, int_val: 4, accidental: 'bs' },
      FBSS: { index: 3, int_val: 4, accidental: 'bss' },
      FBB: { index: 3, int_val: 3, accidental: 'bb' },
      FBBS: { index: 3, int_val: 3, accidental: 'bbs' },
      FK: { index: 3, int_val: 3, accidental: 'k' },
      FO: { index: 3, int_val: 3, accidental: 'o' },
      FAFHF: { index: 3, int_val: 3, accidental: 'afhf' },
      FASHS: { index: 3, int_val: 3, accidental: 'ashs' },
      G: { index: 4, int_val: 7 },
      'G+': { index: 4, int_val: 7, accidental: '+' },
      'G++': { index: 4, int_val: 7, accidental: '++' },
      'G+-': { index: 4, int_val: 7, accidental: '+-' },
      'G++-': { index: 4, int_val: 7, accidental: '++-' },
      ...
      GD: { index: 4, int_val: 9, accidental: 'd' },
      GDB: { index: 4, int_val: 9, accidental: 'db' },
      GB: { index: 4, int_val: 6, accidental: 'b' },
      GBS: { index: 4, int_val: 6, accidental: 'bs' },
      GBSS: { index: 4, int_val: 6, accidental: 'bss' },
      GBB: { index: 4, int_val: 5, accidental: 'bb' },
      GBBS: { index: 4, int_val: 5, accidental: 'bbs' },
      GK: { index: 4, int_val: 5, accidental: 'k' },
      GO: { index: 4, int_val: 5, accidental: 'o' },
      GAFHF: { index: 4, int_val: 5, accidental: 'afhf' },
      GASHS: { index: 4, int_val: 5, accidental: 'ashs' },
      A: { index: 5, int_val: 9 },
      'A+': { index: 5, int_val: 9, accidental: '+' },
      'A++': { index: 5, int_val: 9, accidental: '++' },
      'A+-': { index: 5, int_val: 9, accidental: '+-' },
      'A++-': { index: 5, int_val: 9, accidental: '++-' },
      ...
      AD: { index: 5, int_val: 11, accidental: 'd' },
      ADB: { index: 5, int_val: 11, accidental: 'db' },
      AB: { index: 5, int_val: 8, accidental: 'b' },
      ABS: { index: 5, int_val: 8, accidental: 'bs' },
      ABSS: { index: 5, int_val: 8, accidental: 'bss' },
      ABB: { index: 5, int_val: 7, accidental: 'bb' },
      ABBS: { index: 5, int_val: 7, accidental: 'bbs' },
      AK: { index: 5, int_val: 7, accidental: 'k' },
      AO: { index: 5, int_val: 7, accidental: 'o' },
      AAFHF: { index: 5, int_val: 7, accidental: 'afhf' },
      AASHS: { index: 5, int_val: 7, accidental: 'ashs' },
      B: { index: 6, int_val: 11 },
      'B+': { index: 6, int_val: 11, accidental: '+' },
      'B++': { index: 6, int_val: 11, accidental: '++' },
      'B+-': { index: 6, int_val: 11, accidental: '+-' },
      'b++-': { index: 6, int_val: 11, accidental: '++-' },
      ...
      BD: { index: 6, int_val: 13, accidental: 'd' },
      BDB: { index: 6, int_val: 13, accidental: 'db' },
      BB: { index: 6, int_val: 10, accidental: 'b' },
      BBS: { index: 6, int_val: 10, accidental: 'bs' },
      BBSS: { index: 6, int_val: 10, accidental: 'bss' },
      BBB: { index: 6, int_val: 9, accidental: 'bb' },
      BBBS: { index: 6, int_val: 9, accidental: 'bbs' },
      BK: { index: 6, int_val: 9, accidental: 'k' },
      BO: { index: 6, int_val: 9, accidental: 'o' },
      BAFHF: { index: 6, int_val: 9, accidental: 'afhf' },
      BASHS: { index: 6, int_val: 9, accidental: 'ashs' },
