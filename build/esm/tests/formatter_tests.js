...
import { Accidental, Annotation, Articulation, Beam, Bend, Dot, Flow, Font, FontWeight, Formatter, FretHandFinger, Note, Registry, Stave, StaveConnector, StaveNote, StringNumber, TextBracket, Tuplet, Voice, } from '../src/index.js';
    ...
    smar.forEach((sm) => {
        ...
        durations.forEach((dd) => {
            ...
            if (sm.lyrics.length > iii) {
                note.addModifier(0, new Annotation(sm.lyrics[iii])
