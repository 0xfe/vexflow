...
function tabNotes(options, contextBuilder) {
    ...
    notes1[0].addModifier(0, new Articulation('a>').setPosition(3));
    notes1[1].addModifier(0, new Articulation('a>').setPosition(4));
    notes1[2].addModifier(0, new Articulation('a.').setPosition(3));
    notes1[3].addModifier(0, new Articulation('a.').setPosition(4));
