...
const ThreeVoicesTests = {
  Start(): void {
    ...
    run('Three Voices - #1', this.threeVoices1);
    run('Three Voices - #2 Complex', this.threeVoices2);
    run('Three Voices - #3', this.threeVoices3);
    run('Auto Adjust Rest Positions - Two Voices', this.autoRestTwoVoices);
    run('Auto Adjust Rest Positions - Three Voices #1', this.autoRestThreeVoices1);
    run('Auto Adjust Rest Positions - Three Voices #2', this.autoRestThreeVoices2);
  },

  threeVoices1: createThreeVoicesTest(
    ['e5/2, e5', { stem: 'up' }],
  ...
  threeVoices2: createThreeVoicesTest(
  ...
  threeVoices3: createThreeVoicesTest(
