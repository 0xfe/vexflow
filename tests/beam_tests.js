...
VF.Test.Beam = (function() {
  ...
  var Beam = {
    ...
    setupContext: function(options, x, y) {
      ...
      var stave = new VF.Stave(10, 10, x || 450)
        .addTrebleGlyph()
        .setContext(ctx)
        .draw();
    ...
    simple: function(options, contextBuilder) {
      ...
      var { stave, context } = Beam.setupContext(options);
    ...
    sixteenth: function(options, contextBuilder) {
      options.contextBuilder = contextBuilder;
      var { context, stave } = Beam.setupContext(options);
    ...
    breakSecondaryBeams: function(options, contextBuilder) {
      options.contextBuilder = contextBuilder;
      var { context, stave } = Beam.setupContext(options, 600);
      ...
      var beam1_1 = new VF.Beam(notes.slice(0, 6)).breakSecondaryAt([1, 3]);
      var beam1_2 = new VF.Beam(notes.slice(6, 12)).breakSecondaryAt([2]);

      var beam2_1 = new VF.Beam(notes2.slice(0, 12)).breakSecondaryAt([3, 7, 11]);
      var beam2_2 = new VF.Beam(notes2.slice(12, 18)).breakSecondaryAt([3]);
    ...
    dotted: function(options, contextBuilder) {
      ...
      beam1_1.setContext(context).draw();
      beam1_2.setContext(context).draw();
      beam1_3.setContext(context).draw();
    ...
    tabBeamsDown: function(options, contextBuilder) {
      ...
      var beam1 = new VF.Beam(notes.slice(1, 7));
      var beam2 = new VF.Beam(notes.slice(8, 11));
      var tuplet = new VF.Tuplet(notes.slice(8, 11)).setTupletLocation(-1);
      var tuplet2 = new VF.Tuplet(notes.slice(11, 14)).setTupletLocation(-1);
    ...
    complexWithAnnotation: function(options, contextBuilder) {
      ...
      var stave = new VF.Stave(10, 40, 400).addClef("treble");
