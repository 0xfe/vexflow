...
Vex.Flow.Test.StaveNote.ticks = function(options) {
  ...
  equals(note.getTicks(), BEAT * 3.75,
...
Vex.Flow.Test.StaveNote.ticksNewApi = function(options) {
  ...
  try {
    ...
    equals(e.code, "BadArguments", "Invalid number of dots 'three' " +
