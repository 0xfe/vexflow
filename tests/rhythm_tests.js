...
Vex.Flow.Test.Rhythm.Start = function() {
  ...
  Vex.Flow.Test.runRaphaelTest("Rhythm Draw - beamed slash notes, some rests (Raphael)",
    Vex.Flow.Test.Rhythm.drawSlashAndBeamAndRests);
...
Vex.Flow.Test.Rhythm.drawBasic = function(options, contextBuilder) {
  ...
  // bar 2
  var notesBar2 = [
    new Vex.Flow.StaveNote({ keys: ["b/4"], duration: "2s",stem_direction: -1 }),
    new Vex.Flow.StaveNote({ keys: ["b/4"], duration: "2s",stem_direction: -1 })
  ];
  ...
  // bar 3
  var notesBar3 = [
    new Vex.Flow.StaveNote({ keys: ["b/4"], duration: "4s",stem_direction: -1 }),
    new Vex.Flow.StaveNote({ keys: ["b/4"], duration: "4s",stem_direction: -1 }),
    new Vex.Flow.StaveNote({ keys: ["b/4"], duration: "4s",stem_direction: -1 }),
    new Vex.Flow.StaveNote({ keys: ["b/4"], duration: "4s",stem_direction: -1 })
  ];
...
Vex.Flow.Test.Rhythm.drawSlashAndBeamAndRests  = function(options, contextBuilder) {
  var ctx = new contextBuilder(options.canvas_sel, 800, 150);
  ...
  var notesBar1_part2 = [
    new Vex.Flow.StaveNote({ keys: ["b/4"], duration: "8r",stem_direction: -1 }),
    new Vex.Flow.StaveNote({ keys: ["b/4"], duration: "8s",stem_direction: -1 }),
    new Vex.Flow.StaveNote({ keys: ["b/4"], duration: "8r",stem_direction: -1 }),
    new Vex.Flow.StaveNote({ keys: ["b/4"], duration: "8s",stem_direction: -1 }),
    new Vex.Flow.StaveNote({ keys: ["b/4"], duration: "8r",stem_direction: -1 }),
  ...
  // Helper function to justify and draw a 4/4 voice
  Vex.Flow.Formatter.FormatAndDraw(ctx, staveBar1, notesBar1_part1.concat(notesBar1_part2));
...
Vex.Flow.Test.Rhythm.drawSixtenthWithScratches  = function(options, contextBuilder) {
  ...
  // bar 1
  var notesBar1_part1 = [
    new Vex.Flow.StaveNote({ keys: ["b/4"], duration: "16s",stem_direction: -1 }),
    new Vex.Flow.StaveNote({ keys: ["b/4"], duration: "16s",stem_direction: -1 }),
    new Vex.Flow.StaveNote({ keys: ["b/4"], duration: "16m",stem_direction: -1 }),
    new Vex.Flow.StaveNote({ keys: ["b/4"], duration: "16s",stem_direction: -1 })
  ];
  ...
  var notesBar1_part2 = [
    new Vex.Flow.StaveNote({ keys: ["b/4"], duration: "16m",stem_direction: -1 }),
    new Vex.Flow.StaveNote({ keys: ["b/4"], duration: "16s",stem_direction: -1 }),
    new Vex.Flow.StaveNote({ keys: ["b/4"], duration: "16r",stem_direction: -1 }),
    new Vex.Flow.StaveNote({ keys: ["b/4"], duration: "16s",stem_direction: -1 })
