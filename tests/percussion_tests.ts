...
const PercussionTests = {
  Start(): void {
    ...
    run('Percussion Basic0', this.basic0);
    run('Percussion Basic1', this.basic1);
    run('Percussion Basic2', this.basic2);
    run('Percussion Snare0', this.snare0);
    run('Percussion Snare1', this.snare1);
    run('Percussion Snare2', this.snare2);
    run('Percussion Snare3', this.snare3);
  },
  ...
  basic0: createSingleMeasureTest((f) => {
    const voice0 = f
      .Voice()
      .addTickables([
  ...
  basic1: createSingleMeasureTest((f) => {
  ...
  basic2: createSingleMeasureTest((f) => {
    const voice0 = f
      .Voice()
      .addTickables([
  ...
  snare0: createSingleMeasureTest((f) => {
    f.Voice().addTickables([
      f
  ...
  snare1: createSingleMeasureTest((f) => {
    f.Voice().addTickables([
      f
  ...
  snare2: createSingleMeasureTest((f) => {
    f.Voice().addTickables([
  ...
  snare3: createSingleMeasureTest((factory) => {
    factory
      .Voice()
      .addTickables([
