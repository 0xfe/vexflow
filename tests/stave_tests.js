...
Vex.Flow.Test.Stave.drawVerticalBar = function(options, contextBuilder) {
  ...
  stave.drawSignoFixed(250, 10);
  stave.drawDoubleVerticalBar(250, true);
  stave.drawCodaFixed(300, 10);
...
Vex.Flow.Test.Stave.drawMultipleMeasures = function(options, contextBuilder) {
	// Get the rendering context
	  ...
	  // bar 1
	  var staveBar1 = new Vex.Flow.Stave(10, 0, 200);
	  staveBar1.setBegBarType(Vex.Flow.Stave.BarType.SINGLE_BARR);
	  staveBar1.setEndBarType(Vex.Flow.Stave.BarType.SINGLE_BAR);
//	  staveBar1.setSymbolTypeLeft(Vex.Flow.Stave.RepetitionType.SEGNO_LEFT, 0);
	  ...
	  staveBar2.setBegBarType(Vex.Flow.Stave.BarType.DOUBLE_BAR);
	  staveBar2.setEndBarType(Vex.Flow.Stave.BarType.END_BAR);
	  staveBar2.setVoltaType(Vex.Flow.Stave.VoltaType.MID, "1.", 0);
	  staveBar2.setSymbolTypeRight(Vex.Flow.Stave.RepetitionType.DC_AL_CODA, 0);
...
Vex.Flow.Test.Stave.drawRepeats = function(options, contextBuilder) {
	// Get the rendering context
	  ...
	  staveBar1.setBegBarType(Vex.Flow.Stave.BarType.REPEAT_BEGIN);
	  staveBar1.setEndBarType(Vex.Flow.Stave.BarType.REPEAT_END);
	  ...
	  staveBar2.setBegBarType(Vex.Flow.Stave.BarType.REPEAT_BEGIN);
	  staveBar2.setEndBarType(Vex.Flow.Stave.BarType.REPEAT_END);
//	  staveBar2.setSymbolType(Vex.Flow.Stave.RepetitionType.SEGNO_LEFT, 0);
	  staveBar2.setContext(ctx).draw();
...
Vex.Flow.Test.Stave.drawVoltaTest = function(options, contextBuilder) {
	// Get the rendering context
	  var ctx = contextBuilder(options.canvas_sel, 700, 200);

	  // bar 1
	  var mm1 = new Vex.Flow.Stave(10, 50, 125);
	  mm1.setBegBarType(Vex.Flow.Stave.BarType.REPEAT_BEGIN);
	  mm1.setSymbolTypeLeft(Vex.Flow.Stave.RepetitionType.SEGNO_LEFT, 0);
	  mm1.addClef("treble");
	  ...
	  mm2.setSymbolTypeRight(Vex.Flow.Stave.RepetitionType.CODA_RIGHT, 0);
	  ...
	  mm3.setVoltaType(Vex.Flow.Stave.VoltaType.BEGIN, "1.", 0);
	  ...
	  mm4.setVoltaType(Vex.Flow.Stave.VoltaType.MID, "1.", 0);
	  ...
	  mm5.setEndBarType(Vex.Flow.Stave.BarType.REPEAT_END);
	  mm5.setVoltaType(Vex.Flow.Stave.VoltaType.END, "1.", 0);
	  ...
	  mm6.setVoltaType(Vex.Flow.Stave.VoltaType.BEGIN_END, "2.", 0);
	  ...
	  mm7.setBegBarType(Vex.Flow.Stave.BarType.DOUBLE_BAR);
	  ...
	  mm8.setEndBarType(Vex.Flow.Stave.BarType.DOUBLE_BAR);
	  mm8.setSymbolTypeRight(Vex.Flow.Stave.RepetitionType.DS_AL_CODA, 25);
	  ...
	  // bar 9 - juxtapose mimth measure
	  var mm9 = new Vex.Flow.Stave(mm8.width + mm8.x + 20, mm1.y, 125);
	  mm9.setEndBarType(Vex.Flow.Stave.BarType.END_BAR);
	  mm9.setSymbolTypeLeft(Vex.Flow.Stave.RepetitionType.CODA_LEFT, 25);
	  mm9.addClef("treble");
