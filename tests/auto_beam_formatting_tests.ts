...
const AutoBeamFormattingTests = {
  Start(): void {
    ...
    run('Simple Auto Beaming', this.simpleAuto);
    run('Auto Beaming With Overflow Group', this.simpleAutoWithOverflowGroup);
    run('Even Group Stem Directions', this.evenGroupStemDirections);
    run('Odd Group Stem Directions', this.oddGroupStemDirections);
    run('Odd Beam Groups Auto Beaming', this.oddBeamGroups);
    run('More Simple Auto Beaming 0', this.moreSimple0);
    run('More Simple Auto Beaming 1', this.moreSimple1);
    run('Beam Across All Rests', this.beamAcrossAllRests);
    run('Beam Across All Rests with Stemlets', this.beamAcrossAllRestsWithStemlets);
    run('Break Beams on Middle Rests Only', this.beamAcrossMiddleRests);
    run('Break Beams on Rest', this.breakBeamsOnRests);
    run('Maintain Stem Directions', this.maintainStemDirections);
    run('Maintain Stem Directions - Beam Over Rests', this.maintainStemDirectionsBeamAcrossRests);
    run('Beat group with unbeamable note - 2/2', this.groupWithUnbeamableNote);
    run('Offset beat grouping - 6/8 ', this.groupWithUnbeamableNote1);
    run('Odd Time - Guessing Default Beam Groups', this.autoOddBeamGroups);
    run('Custom Beam Groups', this.customBeamGroups);
    run('Simple Tuplet Auto Beaming', this.simpleTuplets);
    run('More Simple Tuplet Auto Beaming', this.moreSimpleTuplets);
    run('More Automatic Beaming', this.moreBeaming);
    run('Automatic Beaming 4/4 with  3, 3, 2 Pattern', this.beamingWithSeveralGroups1);
    run('Automatic Beaming 4/4 with  3, 3, 2 Pattern and Overflow', this.beamingWithSeveralGroupsOverflow);
    run('Automatic Beaming 8/4 with  3, 2, 3 Pattern and 2 Overflows', this.beamingWithSeveralGroupsOverflow2);
    run('Automatic Beaming 8/4 with  3, 2, 3 Pattern and 3 Overflows', this.beamingWithSeveralGroupsOverflow3);
    run('Duration-Based Secondary Beam Breaks', this.secondaryBreaks);
    run('Duration-Based Secondary Beam Breaks 2', this.secondaryBreaks2);
    run('Flat Beams Up', this.flatBeamsUp);
    run('Flat Beams Down', this.flatBeamsDown);
    run('Flat Beams Mixed Direction', this.flatBeamsMixed);
    run('Flat Beams Up (uniform)', this.flatBeamsUpUniform);
    run('Flat Beams Down (uniform)', this.flatBeamsDownUniform);
    run('Flat Beams Up Bounds', this.flatBeamsUpBounds);
    run('Flat Beams Down Bounds', this.flatBeamsDownBounds);
  },

  simpleAuto(options: TestOptions): void {
  ...
  simpleAutoWithOverflowGroup(options: TestOptions): void {
    const f = VexFlowTests.makeFactory(options);
    const stave = f.Stave();
    const score = f.EasyScore();
  ...
  evenGroupStemDirections(options: TestOptions): void {
    const f = VexFlowTests.makeFactory(options);
    const stave = f.Stave();
    const score = f.EasyScore();
  ...
  oddBeamGroups(options: TestOptions): void {
    const f = VexFlowTests.makeFactory(options);
    const stave = f.Stave();
    const score = f.EasyScore();
  ...
  moreSimple0(options: TestOptions): void {
    const f = VexFlowTests.makeFactory(options);
    const stave = f.Stave();
    const score = f.EasyScore();
  ...
  moreSimple1(options: TestOptions): void {
    const f = VexFlowTests.makeFactory(options);
    const stave = f.Stave();
    const score = f.EasyScore();
  ...
  breakBeamsOnRests(options: TestOptions): void {
    const f = VexFlowTests.makeFactory(options);
    const stave = f.Stave();
    const score = f.EasyScore();
  ...
  beamAcrossAllRestsWithStemlets(options: TestOptions): void {
    const f = VexFlowTests.makeFactory(options);
    const stave = f.Stave();
    const score = f.EasyScore();
  ...
  beamAcrossAllRests(options: TestOptions): void {
    const f = VexFlowTests.makeFactory(options);
    const stave = f.Stave();
    const score = f.EasyScore();
  ...
  beamAcrossMiddleRests(options: TestOptions): void {
    const f = VexFlowTests.makeFactory(options);
    const stave = f.Stave();
    const score = f.EasyScore();
  ...
  maintainStemDirections(options: TestOptions): void {
  ...
  maintainStemDirectionsBeamAcrossRests(options: TestOptions): void {
    const f = VexFlowTests.makeFactory(options, 450, 200);
    const stave = f.Stave();
    const score = f.EasyScore();
  ...
  groupWithUnbeamableNote(options: TestOptions): void {
    const f = VexFlowTests.makeFactory(options, 450, 200);
  ...
  groupWithUnbeamableNote1(options: TestOptions): void {
    const f = VexFlowTests.makeFactory(options, 450, 200);
  ...
  autoOddBeamGroups(options: TestOptions): void {
  ...
  customBeamGroups(options: TestOptions): void {
    const f = VexFlowTests.makeFactory(options, 450, 400);
    const score = f.EasyScore();
  ...
  simpleTuplets(options: TestOptions): void {
    const f = VexFlowTests.makeFactory(options);
    const stave = f.Stave();
    const score = f.EasyScore();
  ...
  moreSimpleTuplets(options: TestOptions): void {
    const f = VexFlowTests.makeFactory(options);
    const stave = f.Stave();
    const score = f.EasyScore();
  ...
  moreBeaming(options: TestOptions): void {
    const f = VexFlowTests.makeFactory(options);
    const stave = f.Stave();
    const score = f.EasyScore();
  ...
  beamingWithSeveralGroups1(options: TestOptions): void {
    const f = VexFlowTests.makeFactory(options);
    const stave = f.Stave();
    const score = f.EasyScore();
  ...
  beamingWithSeveralGroupsOverflow(options: TestOptions): void {
    const f = VexFlowTests.makeFactory(options);
    const stave = f.Stave();
    const score = f.EasyScore();
  ...
  beamingWithSeveralGroupsOverflow2(options: TestOptions): void {
    const f = VexFlowTests.makeFactory(options);
    const stave = f.Stave();
    const score = f.EasyScore();
  ...
  beamingWithSeveralGroupsOverflow3(options: TestOptions): void {
    const f = VexFlowTests.makeFactory(options);
    const stave = f.Stave();
    const score = f.EasyScore();
  ...
  secondaryBreaks(options: TestOptions): void {
    const f = VexFlowTests.makeFactory(options);
    const stave = f.Stave();
    const score = f.EasyScore();
  ...
  secondaryBreaks2(options: TestOptions): void {
    const f = VexFlowTests.makeFactory(options);
    const stave = f.Stave();
    const score = f.EasyScore();
  ...
  flatBeamsUp(options: TestOptions): void {
    const f = VexFlowTests.makeFactory(options);
  ...
  flatBeamsDown(options: TestOptions): void {
    const f = VexFlowTests.makeFactory(options, 450, 200);
    const stave = f.Stave({ y: 40 });
    const score = f.EasyScore();
  ...
  flatBeamsMixed(options: TestOptions): void {
    const f = VexFlowTests.makeFactory(options, 450, 200);
    const stave = f.Stave({ y: 40 });
    const score = f.EasyScore();
  ...
  flatBeamsUpUniform(options: TestOptions): void {
    const f = VexFlowTests.makeFactory(options);
    const stave = f.Stave({ y: 40 });
    const score = f.EasyScore();
  ...
  flatBeamsDownUniform(options: TestOptions): void {
    const f = VexFlowTests.makeFactory(options, 450, 200);
    const stave = f.Stave({ y: 40 });
    const score = f.EasyScore();
